...
public class Userdetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reg=b.getString("reg");
        Task task=new Task();
        task.execute("check",reg);
        v=(Button)findViewById(R.id.verify);
        v.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new Task().execute("verify",reg);
            }
        });
    }
    class Task extends AsyncTask<String, String, ArrayList> {
        ...
        protected void onPostExecute(ArrayList result) {
            ...
            if (token.equals("check")) {
                ...
                Toast.makeText(Userdetail.this, result.get(0).toString(), Toast.LENGTH_LONG).show();
            }
        }
